...
If COM_PORT.Started Then Synchronous_Write COM_PORT.Handle, Left$(Put_Character, LONG_1), LONG_1, Bytes_Sent
...
If COM_PORT.Started Then Synchronous_Read COM_PORT.Handle, Get_Character, LONG_1, Bytes_Read
